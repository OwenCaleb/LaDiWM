...
parser.add_argument("--suite", default="libero_10", choices=["libero_spatial", "libero_object", "libero_goal", "libero_10", "libero_complex"],
...
#suite_name_list = ["libero_90", "libero_90", "libero_90", "libero_10", "libero_10", "libero_goal", "libero_object", "libero_object", "libero_object", ]
...
command = (f'python -m engine.eval_mv_bc_text_action --config-dir={exp_dir} --config-name=config hydra.run.dir=/tmp '
            f'+save_path={exp_dir} '
            ...
            f'env_cfg.render_gpu_ids="{env_gpu_ids}" env_cfg.vec_env_num=5 ')
